...
request('https://fantasyfootballers.org/wr-wide-receiver-nfl-stats/', function (error, response, body) {
  ...
  // console.log(body);
    ...
    tableRows.slice(1).each(function(i, element) {
      "use strict";
      let cleanRow = [];
      let justThese = [1, 2, 3, 4, 5, 6, 8, 11];
      ...
      connection.query("INSERT INTO widereceivers (player, team, recydsgm, rectgtgm, recgm, recyds, rectds, games) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [
              filteredRow[0],
              filteredRow[1],
              filteredRow[2],
              filteredRow[3],
